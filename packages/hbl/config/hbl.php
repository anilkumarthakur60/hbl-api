...
return [
    ...
    */
    ...
    'payment_jose_redirect_url' => [
        'success' => (string) env('HBL_JOSE_REDIRECT_URL_SUCCESS', config('app.url', 'http://hbl.test').'/success'),
        'failed' => (string) env('HBL_JOSE_REDIRECT_URL_FAILED', config('app.url', 'http://hbl.test').'/failed'),
        'cancel' => (string) env('HBL_JOSE_REDIRECT_URL_CANCEL', config('app.url', 'http://hbl.test').'/cancel'),
        'backend' => (string) env('HBL_JOSE_REDIRECT_URL_BACKEND', config('app.url', 'http://hbl.test').'/backend'),
    ],
];
